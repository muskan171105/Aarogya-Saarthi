...
// Function to generate hash from JSON data (Ethers.js v5 compatible)
...
// Function to run MongoDB sync every 6 hours
async function startSync() {
    console.log("Starting MongoDB Sync with Ethereum...");
    await watchMongoDB();
    console.log("Sync completed. Waiting for the next run...");
}

// Run sync every 6 hours
setInterval(startSync, 6 * 60 * 60 * 1000);
